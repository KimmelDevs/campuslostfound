      ...
      <div className="bg-[#2c3e50] py-8 shadow-lg">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <p className="text-gray-300 mt-2">
            Communicate with people about lost and found items
          </p>
        </div>
      </div>
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            {filteredChats.map(chat => (
              <div 
                ...
                onClick={() => router.push(`/dashboard/messages/chat?id=${chat.id}`)}
              >
          ...
          <div className="bg-white rounded-xl shadow-lg p-12 text-center">
            <div className="mx-auto max-w-md">
              ...
              <p className="mt-1 text-gray-500">
                {searchTerm ? 'Try different search terms' : 'Start a conversation from an item listing'}
              </p>
            </div>
          </div>
        )}
